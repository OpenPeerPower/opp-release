"""Helper for the Open Peer Power repository."""
...
def update_frontend_version(value):
    ...
    manifest_path = PATH / "openpeerpower/components/frontend/manifest.json"
    manifest = json.loads(manifest_path.read_text())
    manifest["requirements"] = [f"open-peer-power-frontend=={value}"]
