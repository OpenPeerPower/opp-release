"""Create the credits page for open-peer-power.io."""
import re
import sys
import threading
import time
...
def generate_credits(num_simul_requests, no_cache, quiet):
    ...
    for login, user_contribs_dict in org_contributors_dict.items():
        ...
        count_string = "{} total commits to the Open Peer Power orga:\n{}".format(
        ...
        # by 'opprelease release-notes' run), a KeyError will occur here.
